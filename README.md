...
Prepare, issue, and track invoices in PureDesktop.
...
Based on a cleaned snapshot from [Nikau-Dev/pureinvoicing](https://github.com/Nikau-Dev/pureinvoicing) at
commit `8af505d1d27665b30b9425d87162747219a173ff` (main branch snapshot, 2026-09-25).
...
Outgoing invoices for PureDesktop: prepare them, issue them as numbered
